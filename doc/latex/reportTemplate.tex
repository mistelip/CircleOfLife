...
\thispagestyle{empty}
\begin{figure}
\includegraphics[angle=90,scale=0.33]{DayProtocol.png}
...
\begin{figure}
\centering
\includegraphics[scale=0.7]{LotkaVolterraThreeAdjusted.pdf}
